		...
		for ($i = 0; $i < count($getlinks); $i++) {
			...
			if (!in_array($Url['scheme'], array('http', 'https', 'ftp'))) echo "<script type='text/javascript'>updateStatus($i, '".lang(24)."');</script>$nn";
				...
				do {
					...
					$_GET['post'] = !empty($_GET['post']) ? unserialize(decrypt(urldecode(trim($_GET['post']))), array('allowed_classes' => false)) : 0;
		...
		<table align="center" width="700" border="0">
			...
			<tr><td width="100%" valign="top">
				<div id="listing" style="display:block;">
					<table border="0" style="width:100%;max-width:710px;">
						<tr><td align="center"><textarea id="links" name="links" rows="25" cols="100" style="width:100%;max-width:640px;height:380px;"></textarea></td></tr>
						<tr><td align="center" valign="top"><input type="submit" value="<?php echo lang(34); ?>" onclick="javascript:HideAll();" /></td></tr>
					</table>
				</div>
				<div id="options" style="display:none;">
					<table cellspacing="5" style="width:100%;max-width:710px;">
						<tbody>
							<tr><td align="center">
								<table align="center">
									<tr>
