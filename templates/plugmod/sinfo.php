...
<?php echo lang(276); ?> = <b><span id="inuse"><?php echo ZahlenFormatieren($belegt); ?></span></b>&nbsp;(<span id="inusepercent"><?php echo round($prozent_belegt,"2"); ?></span> %)
<div class="meter"><span id="diskbar" style="width:<?php echo round($prozent_belegt,"2"); ?>%;"></span></div>
