...
<body>
<center>
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" width="52" height="52" role="img" aria-label="RapidLeech">
	<defs>
...
<div style="font-size:19px;font-weight:700;letter-spacing:-0.02em;margin-top:6px;">RapidLeech <span style="font-size:11px;font-weight:600;letter-spacing:0.08em;text-transform:uppercase;color:#64748b;">Setup</span></div>
</center>
<br />
